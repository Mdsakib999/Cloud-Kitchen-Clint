          ...
          <div key={index} className="group relative">
            ...
            >
              ...
              <div className="w-full lg:w-1/2 space-y-6">
                ...
                <h2 className="text-3xl lg:text-4xl font-black text-white leading-tight group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-primary group-hover:to-tertiary group-hover:bg-clip-text transition-all duration-500">
                  {blog.title}
                </h2>
